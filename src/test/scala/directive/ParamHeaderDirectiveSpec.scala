  ...
  "The LiteralIncludeService" should {
    ...
    /*"return a json string for GET requests without parameters and malformed path" in {
      ...
      Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/cb3b7ac188a29812e1811e44f2e676363cd35705999999999").withHeaders(List(RawHeader("Content-Type", "jsonp"))) ~> myRoute ~> check {
        responseAs[String] must contain("Thc/Pz9aPz8/Pz8/P1t5P1pyP3I/RyFqPz8/Pz9qd1w/e1o/eic/LT4/Pz8=")
        contentType === ContentTypes.`application/json`
      }
    }*/
    "return a json string for GET requests without parameters" in {

      Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha).withHeaders(List(RawHeader("Content-Type", "jsonp"))) ~> myRoute ~> check {
    ...
    "return a json string for GET requests without parameters and Content-Type: text/plain" in {
      ...
      Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha).withHeaders(List(RawHeader("Content-Type", "text/plain"))) ~> myRoute ~> check {
    ...
    "return a json string for GET requests with line range L1-L2" in {
      ...
      Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?lines=2-10") ~> addHeader("Content-Type", "jsonp") ~> myRoute ~> check {
        responseAs[String] must contain("fileContent")
        contentType === ContentTypes.`application/json`
      }
    }
    "return a json string for GET requests with lines" in {
      ...
      Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?lines=-10") ~> addHeader("Content-Type", "jsonp") ~> myRoute ~> check {
        responseAs[String] must contain("fileContent")
        contentType === ContentTypes.`application/json`
      }
    }
    "return a json string for GET requests with dedent" in {
      ...
      Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?dedent=2") ~> addHeader("Content-Type", "jsonp") ~> myRoute ~> check {
        responseAs[String] must contain("fileContent")
        contentType === ContentTypes.`application/json`
      }
    }
    "return a json string for GET requests with dedent and lines and no jsonp specified" in {
      ...
      Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?lines=-10&dedent=2").withHeaders(List(RawHeader("Content-Type", "jsonp"))) ~> myRoute ~> check {
        responseAs[String] must contain("fileContent")
        contentType === ContentTypes.`application/json`
      }
    }
    "return a javascript string for GET requests with jsonp, dedent and lines" in {
      ...
      Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?jsonp=result&lines=-10&dedent=2").withHeaders(List(RawHeader("Content-Type", "jsonp"))) ~> myRoute ~> check {
    ...
    "The LiteralIncludeService check" should {
      ...
      "fail for GET requests with empty lines parameter" in {
        ...
        Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?lines=").withHeaders(List(RawHeader("Content-Type", "jsonp"))) ~> myRoute ~> check {
      ...
      "fail with error message for requests without headers specified" in {
        ...
        Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha) ~> myRoute ~> check {
          rejectionConstruct("")
        }
      }
      "fail for GET requests with string values of lines parameter" in {

        Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?lines=aaa").withHeaders(List(RawHeader("Content-Type", "jsonp"))) ~> myRoute ~> check {
      ...
      "fail for GET requests with lines= 20-aaa" in {
        ...
        Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?lines=20-aaa").withHeaders(List(RawHeader("Content-Type", "jsonp"))) ~> myRoute ~> check {
          val message = "requirement failed: line values should be integers"
          rejectionConstruct(message)
        }
      }
      "fail for GET requests with lines parameter = L1 > L2" in {
        ...
        Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?lines=40-9").withHeaders(List(RawHeader("Content-Type", "jsonp"))) ~> myRoute ~> check {
      ...
      "fail for GET requests with negative dedent parameter" in {
        ...
        Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?dedent=-1").withHeaders(List(RawHeader("Content-Type", "jsonp"))) ~> myRoute ~> check {
      ...
      "fail for GET requests with String values of dedent parameter" in {
        ...
        Get("/github/code/LoyolaChicagoCode/scala-tdd-fundamentals/"+sha+"?dedent=aaa").withHeaders(List(RawHeader("Content-Type", "jsonp"))) ~> myRoute ~> check {
